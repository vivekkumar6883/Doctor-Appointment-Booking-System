...
<html lang="en">
	...
	<body>
		...
		<nav class="navbar navbar-default " role="navigation">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="patient.php"><img alt="Brand" src="assets/img/viv.png" height="35px"></a>
				</div>
		...
		<!-- 1st section start -->
		<section id="promo-1" class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/vv.png" height="2px"">
                      <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/vv.png" height="600px" width="1450px"></a>
			<div class="container">
				<div class="row">
