...
//INSERT
$query = " INSERT INTO patient (  icPatient, password, patientFirstName, patientLastName, patientMaritialStatus ,patientDOB, patientGender,  patientAddress, patientPhone, patientEmail )
VALUES ( '$icPatient', '$password', '$patientFirstName', '$patientLastName', '$patientMaritialStatus' ,'$patientDOB', '$patientGender', '$patientAddress',
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/viv.png" height="44px"></a>
                </div>
                ...
                <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <input type="number" name="patientPhone" value="" class="form-control input-lg" placeholder="Your Phone Number"  required/>
					...
					<label>Maritial Status : </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="patientMaritialStatus" value="single" required/>Single
                                        </label>
                                        <label class="radio-inline" >
                                            <input type="radio" name="patientMaritialStatus" value="married" required/>Married
                                        </label>
					<label class="radio-inline" >
                                            <input type="radio" name="patientMaritialStatus" value="seperated" required/>Seperated
                                        </label>
					<label class="radio-inline" >
                                            <input type="radio" name="patientMaritialStatus" value="divorced" required/>Divorced
                                        </label>
					<label class="radio-inline" >
                                            <input type="radio" name="patientMaritialStatus" value="widowed" required/>Widowed
                                        </label>
...
<a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/cvs.png" height="400px"></a>
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">Project By: Vivek Kumar Cheepurupalli</p>
